...
function MoreProjects(props) {
  return (
    ...
    <div className="dark-grey-text text-center mb-4 py-5 mt-4">
      <h2 className="h1-responsive font-weight-bold text-center">More Work</h2>
      <p className="text-center text-muted w-responsive mx-auto mb-5">
        ...
        worked on during the journey to become a Full Stack Web Developer. Every
        one of them contains a link to the Live site and Repository, Enjoy
        them!.
      </p>
      ...
      <div className="row py-5" >
        <div className="col-lg-4 col-md-4 mb-4">
          <div className="view overlay z-depth-2" style={{ height: "100%" }}>
            <img src={weatherImage} className="img-fluid" alt="wheaterImage" style={{ height: "100%", width:"100%" }} />
        ...
        <div className="col-lg-4 col-md-4 mb-4">
          <div className="view overlay z-depth-2" style={{ height: "100%" }}>
            <img src={passwordImage} className="img-fluid" alt="passwordImage" style={{ height: "100%", width:"100%" }} />
            <div className=" mask flex-center blue-gradient-rgba">
              <a
                className="btn btn-outline-white btn-rounded"
        ...
        <div className="col-lg-4 col-md-4 mb-4">
          <div className="view overlay z-depth-2" style={{ height: "100%" }}>
            <img src={quizImage} className="img-fluid" alt="quizImage" style={{ height: "100%", width:"100%" }}/>
            <div className="mask flex-center blue-gradient-rgba">
              <a
                className="btn btn-outline-white btn-rounded"
      ...
      <div className="row py-5" >
        ...
        <div className="col-lg-4 col-md-4 mb-4">
          <div className="view overlay z-depth-2" style={{ height: "100%" }}>
            <img src={employeeImage} className="img-fluid" alt="employyeImage" style={{ height: "100%", width:"100%" }} />
            <div className=" mask flex-center blue-gradient-rgba">
              <a
                className="btn btn-outline-white btn-rounded"
        ...
        <div className="col-lg-4 col-md-4 mb-4">
          <div className="view overlay z-depth-2" style={{ height: "100%" }}>
            <img src={notetakerImage} className="img-fluid" alt="notetakerImage" style={{ height: "100%", width:"100%" }}/>
            <div className="mask flex-center blue-gradient-rgba">
              <a
                className="btn btn-outline-white btn-rounded"
