      ...
      <div className="dark-grey-text text-center mb-4 py-5">
        ...
        <div className="row py-5">
          ...
          <div className="col-lg-4 col-md-12 col-sm-12 mb-4">
            ...
            <p className="text-uppercase text-center text-muted mt-4 mb-0">
              Bicycle App shop is an eCommerce app that allows bike shop owners
              to sell cycling related products online, to shoppers through a
              very friendly UI. This webpage also provides a management system,
              along with operational features that allow owners to offer new
              products.
            </p>
          </div>
          ...
          <div className="col-lg-4 col-md-12 col-sm-12 mb-4">
            <div className="view overlay z-depth-2" style={{ height: "100%" }}>
              ...
              <div className=" mask flex-center blue-gradient-rgba">
                <a
                  className="btn btn-outline-white btn-rounded"
                  href="https://chernanma.github.io/Project_1/"
                  target="blank"
                >
                  Livesite
                </a>
                <a
                  className="btn btn-outline-white btn-rounded"
                  href="https://github.com/chernanma/Project_1"
                  target="blank"
                >
                  Repository
                </a>
            ...
            <p className="text-uppercase text-center text-muted mt-4 mb-0">
              ...
              city and view instantaneous status and trends pertaining to the
              Coronavirus disease.
            </p>
          </div>
        </div>
